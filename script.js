...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Check if intro has been played - if not, don't show welcome page yet
  ...
  if (introPlayed) {
    ...
    // Intro hasn't played yet, cinematic intro will handle showing welcome page
    console.log("Cinematic intro will handle page display");
    showPage('visitor-form'); // Directly show the personal information page
  }
